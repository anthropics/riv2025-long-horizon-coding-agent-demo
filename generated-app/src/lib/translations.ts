...
const translations: Record<Language, Translations> = {
  ...
  ko: {
    ...
    velocityChart: '속도 차트',
    sprintReport: '스프린트 보고서',
    trackSprintProgress: '스프린트 진행 상황 추적',
    ...
    // Settings Page
    settings: '설정',
    settingsDescription: '환경 설정 및 애플리케이션 설정 관리',
    profile: '프로필',
    profileDescription: '개인 정보 업데이트',
    name: '이름',
    email: '이메일',
    saveProfile: '프로필 저장',
    appearance: '외관',
    appearanceDescription: 'Canopy 외관 사용자 정의',
    mode: '모드',
    light: '라이트',
    dark: '다크',
    system: '시스템',
    ...
    defaultProjectDescription: '기본으로 열 프로젝트 선택',
    noDefaultProject: '기본 프로젝트 없음',
    dataManagement: '데이터 관리',
    dataManagementDescription: '데이터 내보내기, 가져오기 또는 삭제',
    exportData: '데이터 내보내기',
    importData: '데이터 가져오기',
    exporting: '내보내는 중...',
    importing: '가져오는 중...',
    exportDescription: 'JSON으로 데이터를 내보내 백업하거나 전송합니다. 이전에 내보낸 데이터를 가져와서 복원합니다.',
    dangerZone: '위험 구역',
    dangerZoneDescription: '모든 데이터에 영향을 미치는 되돌릴 수 없는 작업',
    clearAllData: '모든 데이터 삭제',
    deleteEverything: '모두 삭제',
    deleteConfirmTitle: '정말로 확실합니까?',
    deleteConfirmDescription: '이렇게 하면 모든 프로젝트, 이슈, 스프린트 및 설정이 영구적으로 삭제됩니다. 이 작업은 되돌릴 수 없습니다. 먼저 데이터를 내보내는 것을 고려하세요.',
    keyboardShortcuts: '키보드 단축키',
    keyboardShortcutsDescription: '파워 유저를 위한 빠른 작업',
    openSearch: '검색 열기',
    createIssue: '이슈 생성',
    goToBoard: '보드로 이동',
    goToBacklog: '백로그로 이동',
    goToSprints: '스프린트로 이동',
    goToSettings: '설정으로 이동',
    aboutCanopy: 'Canopy 정보',
    aboutDescription: 'Canopy는 단순함과 집중을 중시하는 팀을 위해 만들어진 숲에서 영감을 받은 프로젝트 관리 도구입니다.',
    version: '버전 1.0.0 • 모든 데이터는 브라우저에 로컬 저장됨',
    ...
    createYourFirstProject: '첫 번째 프로젝트 만들기',
    welcomeMessage: 'Canopy에 오신 것을 환영합니다',
    noProjectsMessage: '첫 번째 프로젝트를 만들어 시작하세요',
    ...
    // Board
    boardView: '보드',
    emptyBoard: '보드가 비어 있습니다',
    emptyBoardDescription: '첫 번째 이슈를 만들어 시작하세요',
    quickFilter: '빠른 필터',
    filterByAssignee: '담당자로 필터링',
    filterByType: '유형으로 필터링',

    // Backlog
    backlogView: '백로그',
    emptyBacklog: '백로그가 비어 있습니다',
    dragToOrder: '드래그하여 순서 변경',
    totalPoints: '총 포인트',
    issuesCount: '이슈',
    ...
    completedSprint: '완료됨',
    noSprints: '스프린트 없음',
    addedToSprint: '스프린트에 추가됨',
    movedToBacklog: '백로그로 이동됨',
    sprintStarted: '스프린트 시작됨',
    sprintCompleted: '스프린트 완료됨',
    failedToStartSprint: '스프린트 시작 실패',
    failedToCompleteSprint: '스프린트 완료 실패',
    manageSprintsDesc: '스프린트 관리 및 진행 상황 추적',
    ...
    createEpic: '에픽 생성',
    noEpics: '에픽 없음',
    createYourFirstEpic: '첫 번째 에픽 만들기',
    issueHierarchy: '이슈 계층 구조',
    childIssues: '하위 이슈',
    progress: '진행률',
    expandAll: '모두 펼치기',
    collapseAll: '모두 접기',
    ...
    completedPoints: '완료된 포인트',
    averageVelocity: '평균 속도',
    sprintStats: '스프린트 통계',
    ...
    noComponents: '컴포넌트 없음',
    componentName: '컴포넌트 이름',
    componentDescription: '컴포넌트 설명',
    componentLead: '컴포넌트 리드',
    manageComponentsFor: '컴포넌트 관리',
    ...
    labelName: '라벨 이름',
    labelColor: '라벨 색상',
    labelDescription: '라벨 설명',
    manageLabelsFor: '라벨 관리',
    ...
    workflowStatuses: '워크플로우 상태',
    defaultWorkflow: '기본 워크플로우',
    ...
    importError: '데이터 가져오기 실패. 파일 형식을 확인하세요.',
    movedTo: '이동됨',
    failedToMoveIssue: '이슈 이동 실패',

    // About
    about: '정보',
    aboutUs: '소개',
    featureOverview: '기능 개요',
    contribution: '기여',

    // Admin Dashboard
    adminDashboard: '관리자 대시보드',
    adminDashboardDescription: 'IndexedDB 데이터 인스펙터',
    databaseTables: '데이터베이스 테이블',
    recordInspector: '레코드 인스펙터',
    totalRecords: '총 레코드 수',
    noRecords: '이 테이블에 레코드가 없습니다',
    selectRecordToInspect: '검사할 레코드 선택',
    exportTable: '테이블 데이터 내보내기',
    refresh: '새로고침',
    refreshing: '새로고침 중...',

    // About Page
    welcomeToCanopy: 'Canopy에 오신 것을 환영합니다',
    aboutHeroDescription: '팀이 함께 계획하고, 추적하고, 훌륭한 작업을 제공하는 데 도움이 되는 JIRA와 같은 프로젝트 관리 도구입니다.',
    ourMission: '우리의 미션',
    simplifyProjectManagement: '프로젝트 관리 간소화',
    missionDescription: 'Canopy는 프로젝트 관리가 직관적이고, 아름답고, 접근 가능해야 한다는 믿음에서 탄생했습니다. 전문적인 도구의 힘과 즐거운 사용자 경험을 결합했습니다.',
    whatMakesCanopySpecial: 'Canopy의 특별한 점',
    sprintPlanning: '스프린트 계획',
    sprintPlanningDesc: '명확한 목표를 가진 집중된 스프린트로 작업 정리',
    kanbanBoard: '칸반 보드',
    kanbanBoardDesc: '드래그 앤 드롭으로 워크플로우 시각화',
    teamCollaboration: '팀 협업',
    teamCollaborationDesc: '작업 할당 및 함께 진행 상황 추적',
    customizable: '사용자 정의 가능',
    customizableDesc: '라벨, 컴포넌트, 프로젝트 설정을 원하는 대로',
    getInvolved: '참여하기',
    contribute: '기여',
    howToMakeRequests: '요청 방법',
    requestsDescription: '피드백을 소중히 여깁니다! 버그 보고 또는 새 기능 요청의 가장 좋은 방법을 소개합니다.',
    bugReports: '버그 보고',
    bugReportsDesc: '무언가 고장났나요? 수정하는 것을 도와주세요!',
    featureRequests: '기능 요청',
    featureRequestsDesc: '아이디어가 있으세요? 듣고 싶습니다!',
    pullRequests: '풀 리퀘스트',
    pullRequestsDesc: '코드 기여는 언제나 환영합니다!',
    stepsToFollow: '따라야 할 단계',
    describeWhatHappened: '무슨 일이 있었는지 설명',
    includeStepsToReproduce: '재현 단계 포함',
    addScreenshotsIfPossible: '가능하면 스크린샷 추가',
    explainTheFeature: '기능 설명',
    shareTheUseCase: '사용 사례 공유',
    describeExpectedBehavior: '예상 동작 설명',
    forkTheRepository: '저장소 포크',
    makeYourChanges: '변경 사항 만들기',
    submitAPr: '설명과 함께 PR 제출',
    bestPractices: '좋은 피드백을 위한 모범 사례',
    beSpecificAndDescriptive: '구체적이고 설명적으로',
    includeBrowserInfo: '버그의 경우 브라우저/기기 정보 포함',
    searchExistingIssues: '먼저 기존 이슈 검색',
    oneIssuePerReport: '보고서당 하나의 이슈',
    useClearTitles: '명확하고 간결한 제목 사용',
    attachScreenshots: '관련 스크린샷 첨부',
    readyToGetStarted: '시작할 준비가 되셨나요?',
    createProjectCTA: '첫 번째 프로젝트를 만들고 Canopy로 체계적이고 아름다운 프로젝트 관리의 즐거움을 경험하세요.',
    createAProject: '프로젝트 만들기',
    viewAllProjects: '모든 프로젝트 보기',
    builtWithLove: '아름다운 도구를 사랑하는 팀을 위해 사랑으로 만들었습니다',

    // Team Page
    teamTitle: '팀',
    teamDescription: '팀 구성원 및 역량 관리',
    addTeamMember: '팀 구성원 추가',
    teamSize: '팀 규모',
    totalAvailableWeeks: '총 가용 주',
    totalCapacityHours: '총 가용 시간',
    member: '구성원',
    availableWeeks: '가용 주',
    hoursPerWeek: '주당 시간',
    assignedTasks: '할당된 작업',
    actions: '작업',
    noTeamMembersYet: '아직 팀 구성원이 없습니다',
    addTeamMemberDesc: '팀 구성원을 추가하여 역량을 추적하고 작업을 할당하세요.',
    addFirstTeamMember: '첫 번째 팀 구성원 추가',
    capacityPlanningTip: '역량 계획 팁',
    capacityPlanningTipDesc: '가용 주는 스프린트 동안 각 팀 구성원에게 얼마나 많은 작업을 할당할 수 있는지 계획하는 데 도움이 됩니다. 휴가 일정, 파트타임 가용성 또는 기타 약속에 따라 이 값을 조정하세요.',
    editTeamMember: '팀 구성원 편집',
    nameRequired: '이름 *',
    ...
    teamMemberAdded: '팀 구성원이 추가되었습니다',
    teamMemberUpdated: '팀 구성원이 업데이트되었습니다',
    teamMemberRemoved: '팀 구성원이 제거되었습니다',
    failedToAddTeamMember: '팀 구성원 추가 실패',
    failedToUpdateTeamMember: '팀 구성원 업데이트 실패',
    failedToRemoveTeamMember: '팀 구성원 제거 실패',

    // Epics Page
    manageEpicsDesc: '에픽을 관리하고 진행 상황을 추적합니다',
    searchEpicsPlaceholder: '에픽 및 하위 이슈 검색...',
    filterByStatus: '상태로 필터링',
    allStatuses: '모든 상태',
    completed: '완료됨',
    issuesDone: '완료된 이슈',
    storyPointsTotal: '총 스토리 포인트',
    noChildIssues: '아직 하위 이슈가 없습니다. 이 에픽에 이슈를 연결하여 진행 상황을 추적하세요.',
    linkIssuesToEpic: '이 에픽에 이슈 연결',
    noEpicsMatchFilters: '필터와 일치하는 에픽이 없습니다',
    tryAdjustingFilters: '검색 또는 필터를 조정해 보세요',
    epicsHelpOrganize: '에픽은 관련 이슈를 더 큰 이니셔티브로 구성하는 데 도움이 됩니다',
    epicParent: '에픽 (상위)',
    projectNotFound: '프로젝트를 찾을 수 없습니다',

    // Completion Story
    completionStoryTitle: '작업 완료!',
    continueConquering: '계속 정복하기',
    ...
    signInToAccessWorkspace: '워크스페이스에 액세스하려면 로그인하세요',
    signUpToStart: '프로젝트 관리를 시작하려면 가입하세요',
    fullName: '이름',
    emailAddress: '이메일 주소',
    password: '비밀번호',
    confirmPassword: '비밀번호 확인',
    atLeast6Characters: '최소 6자',
    ...
    // Velocity Page
    trackTeamVelocity: '스프린트 전체의 팀 속도 추적',
    ptsPerSprint: '포인트/스프린트',
    commitmentReliability: '약속 신뢰도',
    sprintsCompleted: '완료된 스프린트',
    velocityTrend: '속도 추세',
    committed: '약속됨',
    recommendations: '권장 사항',
    sprintPlanningSuggestion: '스프린트 계획 제안',
    recommendedCommitment: '팀의 속도를 기반으로 다음 스프린트에 권장되는 약속:',
    completionRate: '완료율',
    completeSprintsToSeeVelocity: '속도 데이터를 보려면 스프린트를 완료하세요',
    reduceCommitmentWarning: '스프린트 약속을 줄이는 것을 고려하세요. 현재 신뢰도가 80% 미만입니다.',
    velocityTrendingDown: '속도가 하향 추세입니다. 팀과 잠재적 장애물을 검토하세요.',
    velocityImproving: '훌륭한 진전! 속도가 향상되고 있습니다. 약속을 약간 늘리는 것을 고려하세요.',
    moreSprintsNeeded: '정확한 속도 예측을 위해 더 많은 스프린트를 완료하세요.',
    teamVelocityStable: '팀 속도가 안정적입니다. 잘하고 있어요!',
    accountsForVariation: '이 범위는 일반적인 스프린트 간 변동을 고려합니다.',

    // Sprint Report Page
    detailedBreakdown: '스프린트 진행 상황의 상세 분석',
    totalIssues: '총 이슈',
    teamPerformance: '팀 성과',
    statusDistribution: '상태 분포',
    issueTypeDistribution: '이슈 유형 분포',
    sprintIssues: '스프린트 이슈',
    sprintDetails: '스프린트 세부 정보',
    duration: '기간',
    notSet: '설정되지 않음',
    noGoalSet: '이 스프린트에 설정된 목표가 없습니다',
    selectSprintToViewReport: '보고서를 보려면 스프린트를 선택하세요',
    pts: '포인트',
    ...
    projectKeyRequired: '프로젝트 키는 필수입니다',
    projectKeyInUse: '이 프로젝트 키는 이미 사용 중입니다',
    keyPrefix: '이슈 키의 접두사로 사용됨',
    describeYourProject: '프로젝트 설명...',
    projectColor: '프로젝트 색상',
    projectCreatedSuccess: '프로젝트가 성공적으로 생성되었습니다!',
    failedToCreateProject: '프로젝트 생성 실패',

    // Project Settings Page
    manageSettingsFor: '설정 관리',
    general: '일반',
    basicProjectInfo: '기본 프로젝트 정보',
    projectKeyCannotChange: '프로젝트 키는 생성 후 변경할 수 없습니다',
    settingsSaved: '설정이 저장되었습니다',
    failedToSaveSettings: '설정 저장 실패',
    workflowSection: '워크플로우',
    assignWorkflow: '이슈가 상태 간에 전환되는 방식을 정의하는 워크플로우 할당',
    workflowDeterminesStatuses: '워크플로우는 이 프로젝트의 이슈에 사용 가능한 상태와 전환을 결정합니다',
    statusFlow: '상태 흐름:',
    saveWorkflow: '워크플로우 저장',
    manageWorkflows: '워크플로우 관리',
    exportSection: '내보내기',
    exportProjectData: '프로젝트 데이터 내보내기',
    downloadProjectJson: '프로젝트 데이터를 JSON으로 다운로드',
    projectExported: '프로젝트가 내보내졌습니다',
    failedToExport: '내보내기 실패',
    restoreProject: '프로젝트 복원',
    archiveProject: '프로젝트 보관',
    restoreProjectDesc: '이 프로젝트를 복원하여 다시 활성화',
    archiveProjectDesc: '활성 목록에서 이 프로젝트 숨기기',
    projectRestored: '프로젝트가 복원되었습니다',
    projectArchived: '프로젝트가 보관되었습니다',
    failedToUpdateProject: '프로젝트 업데이트 실패',
    deleteProjectTitle: '프로젝트 삭제',
    deleteProjectWarning: '이 작업은 되돌릴 수 없습니다. 이슈, 스프린트, 댓글을 포함한 프로젝트와 모든 관련 데이터가 영구적으로 삭제됩니다.',
    typeToConfirm: '확인하려면 {key}를 입력하세요',
    projectDeleted: '프로젝트가 삭제되었습니다',
    failedToDeleteProject: '프로젝트 삭제 실패',

    // Projects Page
    manageViewProjects: '모든 프로젝트 관리 및 보기',
    searchProjectsPlaceholder: '프로젝트 검색...',
    showActive: '활성 표시',
    showArchived: '보관된 항목 표시',
    noProjectsMatchSearch: '검색과 일치하는 프로젝트가 없습니다',
    noArchivedProjects: '보관된 프로젝트가 없습니다',
    noProjectsYet: '아직 프로젝트가 없습니다',

    // Emoji Creator
    emojiCreator: '이모지 만들기',
    emojiCreatorDescription: '채팅 및 반응을 위한 맞춤 이모지 디자인',
    createEmoji: '이모지 만들기',
    createFirstEmoji: '첫 번째 이모지 만들기',
    noEmojisYet: '아직 맞춤 이모지가 없습니다',
    noEmojisDescription: '채팅 및 반응에 사용할 첫 번째 맞춤 이모지를 만드세요. 모양, 표정, 색상을 선택하세요!',
    designYourEmoji: '이모지 디자인',
    emojiDesignDescription: '다양한 모양, 표정, 액세서리로 이모지 사용자 정의',
    emojiName: '이모지 이름',
    emojiNamePlaceholder: '예: 행복한 해',
    shape: '모양',
    expression: '표정',
    accessory: '액세서리',
    faceColor: '얼굴 색상',
    accentColor: '강조 색상 (눈, 입)',
